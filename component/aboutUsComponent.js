async function executeAboutUs(){
    // await saveLog(user.LoggedInInvestorId, 'About Us');
    ...
    function aboutUs(){
        document.getElementById('mainContentSection').innerHTML = `
            ...
            <div onscroll="resetLogoutTimer()" style="flex: 1 1 auto; height: 100%; overflow-y: auto;">
                <div class="aboutUsContent">
                    <div class="container content" id="aboutUsData"></div>
                </div>
                <div class="officeLocationSection">
                    <div class="container">
                        <div id="officeLocation"></div>
                    </div>
                </div>
            </div>
            <div style="flex: 0 0 auto;" class="container aboutUsFooter">
                <div id="aboutFooter" class="footerContent"></div>
            </div>
        `
    }
    ...
    function renderOfficeLocation(data){
        ...
        officeLocationData.forEach(item => {
            ...
            newDiv.innerHTML = `
                <h4 style='text-align:center; margin: 0; padding: 10px 0px;font-size: 18px;'>${item.Name}</h4>
                <p>${item.Address}</p>
            ...
            if(item.Name === 'Registered Office'){
