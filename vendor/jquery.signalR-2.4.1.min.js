...
(function (n, t, i) {
    ...
    r.fn = r.prototype = {
        ...
        start: function (i, h) {
            var a = this,
                v = { pingInterval: 3e5, waitForPageLoad: !0, transport: "auto", jsonp: !1 },
                g,
                ...
                nt = function (i, u) {
                    (i.url === u && i.baseUrl) ||
                        ((i.url = u),
                        (b.href = i.url),
                        b.protocol && b.protocol !== ":" ? ((i.protocol = b.protocol), (i.host = b.host)) : ((i.protocol = t.document.location.protocol), (i.host = b.host || t.document.location.host)),
                        (i.baseUrl = i.protocol + "//" + i.host),
                        (i.wsProtocol = i.protocol === "https:" ? "wss://" : "ws://"),
                        i.url.indexOf("//") === 0 && ((i.url = t.location.protocol + i.url), i.log("Protocol relative URL detected, normalizing it to '" + i.url + "'.")),
                        i.isCrossDomain(i.url) &&
                            (i.log("Auto detected cross domain url."),
                            ...
                            n.support.cors || ((i.ajaxDataType = "jsonp"), i.log("Using jsonp because this browser doesn't support CORS.")),
            ...
            if ((n.type(i) === "function" ? (h = i) : n.type(i) === "object" && (n.extend(v, i), n.type(v.callback) === "function" && (h = v.callback)), (v.transport = w(v.transport, a)), !v.transport))
            ...
            return ((a._.config = v), !o && v.waitForPageLoad === !0)
                ...
                ? y.promise()
                : s(a, r.connectionState.disconnected, r.connectionState.connecting) === !1
                      ...
                      var t,
                          ...
                          l = function (n, t) {
                              ...
                              return (
                                  ...
                                  n.accessToken && (i.headers = { Authorization: "Bearer " + n.accessToken }),
                          ...
                          p = function (c) {
                              ...
                              t.KeepAliveTimeout
                                  ? ((i.activated = !0), (i.timeout = t.KeepAliveTimeout * 1e3), (i.timeoutWarning = i.timeout * a.keepAliveWarnAt), (a._.beatInterval = (i.timeout - i.timeoutWarning) / 3))
                                  : (i.activated = !1);
        ...
        stop: function (i, h) {
            ...
            if (a.state !== r.connectionState.disconnected)
                return (
                    ...
                    a.transport && (a.transport.stop(a), h !== !1 && a.transport.abort(a, i), l(a) && r.transports._logic.stopMonitoringKeepAlive(a), (a.transport = null)),
                    a._.negotiateRequest && (a._.negotiateRequest.abort(c), delete a._.negotiateRequest),
    ...
    (function (n, t, i) {
        ...
        function l(t) {
            ...
            t.state === r.connectionState.connected &&
                ...
                u >= i.timeout
                    ? (t.log("Keep alive timed out.  Notifying transport that connection has been lost."), t.transport.lostConnection(t))
                    : u >= i.timeoutWarning
                    ? i.userNotified || (t.log("Keep alive has been missed, connection may be dead/slow."), n(t).triggerHandler(f.onConnectionSlow), (i.userNotified = !0))
                    : (i.userNotified = !1));
        }
        function e(n, t) {
            var i = n.url + t;
        ...
        h.prototype = {
            ...
            transportFailed: function (i, u, e) {
                ...
                this.connectionStopped ||
                    ...
                    this.startRequested
                        ? this.startCompleted ||
                          ((s = r._.error(r.resources.errorDuringStartRequest, u)), o.log(i.name + " transport failed during the start request. Stopping the connection."), n(o).triggerHandler(f.onError, [s]), h && h.reject(s), o.stop())
                        : (i.stop(o), o.log(i.name + " transport failed to connect. Attempting to fall back."), e()));
            },
        };
        u = r.transports._logic = {
                          ...
                          (f = u.ajax(t, {
                              ...
                              error: function (n) {
                                  n.status === 401 || n.status === 403
                                      ? (i.reject(r._.transportError(r._.format(r.resources.pingServerFailedStatusCode, n.status), t.transport, n, f)), t.stop())
                                      : i.reject(r._.transportError(r.resources.pingServerFailed, t.transport, n, f));
                              },
                          })))
            ...
            getUrl: function (n, i, r, f, e) {
                var h = i === "webSockets" ? "" : n.baseUrl,
                    ...
                    s = "transport=" + i;
                return (
                    !e && n.groupsToken && (s += "&groupsToken=" + t.encodeURIComponent(n.groupsToken)),
            ...
            maximizePersistentResponse: function (n) {
                return { MessageId: n.C, Messages: n.M, Initialized: typeof n.S != "undefined" ? !0 : !1, ShouldReconnect: typeof n.T != "undefined" ? !0 : !1, LongPollDelay: n.L, GroupsToken: n.G, Error: n.E };
            },
            ...
            processMessages: function (t, i, f) {
                ...
                if ((u.markLastMessage(t), i)) {
                    ...
                    e.Messages &&
                        (n.each(e.Messages, function (n, i) {
                            u.triggerReceived(t, i);
                        }),
            ...
            monitorKeepAlive: function (t) {
                var i = t._.keepAliveData;
                i.monitoring
                    ? t.log("Tried to monitor keep alive but it's already being monitored.")
                    : ((i.monitoring = !0),
                      u.markLastMessage(t),
    ...
    (function (n, t) {
        ...
        i.transports.webSockets = {
            ...
            start: function (e, o, s) {
                ...
                e.socket ||
                    ((h = e.webSocketServerUrl ? e.webSocketServerUrl : e.wsProtocol + e.host),
                    ...
                    (e.socket.onclose = function (t) {
                        ...
                        this === e.socket &&
                            (c && typeof t.wasClean != "undefined" && t.wasClean === !1
                                ? ((r = i._.transportError(i.resources.webSocketClosed, e.transport, t)), e.log("Unclean disconnect from websocket: " + (t.reason || "[no reason given].")))
                                : e.log("Websocket closed."),
                            (s && s(r)) || (r && n(e).triggerHandler(u.onError, [r]), l.reconnect(e)));
                    }),
                    ...
                    function (n) {
                        ...
                        this === o.eventSource &&
                            ((h && h(r)) ||
                                ...
                                n.eventPhase === t.EventSource.CLOSED ? (o.log("EventSource reconnecting due to the server connection ending."), c.reconnect(o)) : (o.log("EventSource error."), a.triggerHandler(u.onError, [r]))));
                    },
                    !1
                );
            },
            ...
            receive: function (t, u) {
                ...
                if (
                    ...
                    t.state === n.signalR.connectionState.connected &&
                        ...
                        t.frameMessageCount > r.transports.foreverFrame.iframeClearThreshold && ((t.frameMessageCount = 0), (f = t.frame.contentWindow || t.frame.contentDocument), f && f.document && f.document.body)))
                )
                ...
                c.pollTimeoutId = t.setTimeout(function () {
                    (function e(s, h) {
                        var g = s.messageId,
                            ...
                            b = {};
                        (s.messageId && (b.messageId = s.messageId), s.groupsToken && (b.groupsToken = s.groupsToken), f(s) !== !0) &&
                            ...
                            (s.pollXhr = i.ajax(o, {
                                ...
                                success: function (r) {
                                    ...
                                    (c.reconnectTimeoutId !== null && p(s), h && (u = i.maximizePersistentResponse(h)), i.processMessages(s, h, v), u && n.type(u.LongPollDelay) === "number" && (w = u.LongPollDelay), f(s) !== !0) &&
                                        ((a = u && u.ShouldReconnect), !a || i.ensureReconnectingState(s)) &&
                                        (w > 0
                                            ? (c.pollTimeoutId = t.setTimeout(function () {
                                                  e(s, a);
                                              }, w))
                                ...
                                error: function (f, h) {
                                    ...
                                    if (!y(v)) {
                                        if (
                                            (l++,
                                            o.state !== r.connectionState.reconnecting && (o.log("An error occurred using longPolling. Status = " + h + ".  Response = " + f.responseText + "."), n(s).triggerHandler(u.onError, [v])),
        ...
        i.fn = i.prototype = {
            ...
            on: function (t, i, u) {
                var c = this,
                    ...
                    s,
                    a;
                for (u = u || i, u._signalRGuid || (u._signalRGuid = o++), t = t.toLowerCase(), f = l[t], f || ((f = []), (l[t] = f)), s = 0; s < f.length; s++)
                    (f[s].guid === u._signalRGuid || (v && f[s].isFromOldGeneratedHubProxy)) && (h = f[s]);
                return (
                    h || ((h = { guid: u._signalRGuid, eventHandlers: [], isFromOldGeneratedHubProxy: v }), l[t].push(h)),
                    (a = function (n, t) {
                        i.apply(c, t);
                    }),
            ...
            off: function (t, i, u) {
                var s = this,
                    ...
                    o,
                    c;
                if (((u = u || i), (t = t.toLowerCase()), (f = l[t]), f))
                    if (i) {
            ...
            invoke: function (t) {
                var i = this,
                    ...
                    o = c(e, l),
                    f = { H: i.hubName, M: t, A: o, I: r._.invocationCallbackId },
                    u = n.Deferred(),
                    s = function (f) {
                        ...
                        e.Progress
                            ...
                            ? (e.StackTrace && r.log(e.Error + "\n" + e.StackTrace + "."),
                              ...
                              u.rejectWith(i, [o]))
                            : (r.log("Invoked " + i.hubName + "." + t), u.resolveWith(i, [e.Result]));
                    };
                return (
                    (r._.invocationCallbacks[r._.invocationCallbackId.toString()] = { scope: i, method: s }),
            ...
            u.received(function (t) {
                ...
                t &&
                    (typeof t.P != "undefined"
                        ? ((e = t.P.I.toString()), (i = u._.invocationCallbacks[e]), i && i.method.call(i.scope, t))
                        : typeof t.I != "undefined"
                        ? ((e = t.I.toString()), (i = u._.invocationCallbacks[e]), i && ((u._.invocationCallbacks[e] = null), delete u._.invocationCallbacks[e], i.method.call(i.scope, t)))
        ...
        t.fn._registerSubscribedHubs = function () {
            ...
            t._subscribedToHubs ||
                ...
                t.starting(function () {
                    ...
                    i.length === 0 &&
                        t.log("No hubs have been subscribed to.  The client will not receive data from hubs.  To fix, declare at least one client side function prior to connection start for each hub you wish to subscribe to.");
